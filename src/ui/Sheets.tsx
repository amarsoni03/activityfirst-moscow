      ...
      {open && (
        <>
          ...
          <motion.aside
            ...
            className={`fixed inset-x-0 bottom-0 z-50 flex max-h-[88svh] w-full flex-col rounded-t-3xl bg-paper pb-[env(safe-area-inset-bottom)] shadow-2xl ${
              from === 'bottom'
                ? ''
                : 'md:inset-y-0 md:right-0 md:left-auto md:max-h-none md:max-w-md md:rounded-none md:pb-0'
            }`}
          ...
          >
            <div
              className={`mx-auto mt-2 h-1 w-10 rounded-full bg-hair ${from === 'bottom' ? '' : 'md:hidden'}`}
              aria-hidden
            />
